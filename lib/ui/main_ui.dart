...
import 'package:flutter_classified_app/Model/product_model.dart';
import 'package:flutter_classified_app/UI/Widgets/custom_shape.dart';
import 'package:flutter_classified_app/UI/Widgets/mainui_customcard.dart';
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    const Text("Today's Deals", style: TextStyle(fontSize: 16)),
                    GestureDetector(
                        onTap: () {
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    ...
                    prints('Routing to Electronics item list');
                  },
                  child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                    onTap: () {
                      ...
                      prints('Routing to Properties item list');
                    },
                    child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                    onTap: () {
                      ...
                      prints('Routing to Jobs item list');
                    },
                    child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                    onTap: () {
                      ...
                      prints('Routing to Furniture item list');
                    },
                    child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    ...
                    prints('Routing to Cars item list');
                  },
                  child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    ...
                    prints('Routing to Bikes item list');
                  },
                  child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                    onTap: () {
                      ...
                      prints('Routing to Mobiles item list');
                    },
                    child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    ...
                    prints('Routing to Pets item list');
                  },
                  child: Image.asset(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    ...
                    prints('Routing to Fashion item list');
                  },
                  child: Image.asset(
  ...
  Widget _buildTrendingEntries(
    ...
    return GestureDetector(
      onTap: () {
        ...
        prints("Routing to trending list page");
      },
      child: CustomCard(
